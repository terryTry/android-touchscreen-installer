...
在 TCP/IP 模式点击“搜索局域网设备”，立即使用第一张可用 IPv4 网卡和默认端口 5555 搜索。需要调整范围时，选择“电脑使用的网络”和扫描端口，再点击“重新搜索”。程序合并所选 IPv4 子网内的 mDNS ADB 服务和端口开放候选；在设备卡片点击“连接此设备”，直接发起 ADB 连接；卡片会显示连接中、已连接或失败原因，并支持原位重试。
